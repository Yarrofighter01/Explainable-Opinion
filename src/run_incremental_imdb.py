...
def run_shard(shard_idx, num_shards, base_model, output_dir, epochs=3):
    print(f"\n{'='*40}")
    print(f"Running IMDb Shard {shard_idx+1}/{num_shards}")
    print(f"{'='*40}\n")
...
def main():
    ...
    parser.add_argument("--base_model", type=str, default="src/results_incremental", help="Initial base model")
    parser.add_argument("--output_dir", type=str, default="src/results_imdb", help="Output directory")
